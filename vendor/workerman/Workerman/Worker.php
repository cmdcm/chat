...
class Worker
{
    ...
    protected static function getEventLoopName()
    {
        ...
        if ($loop_name) {
            if (interface_exists('\React\EventLoop\LoopInterface',false)) {
                switch ($loop_name) {
                    case 'libevent':
            ...
            self::$eventLoopClass = interface_exists('\React\EventLoop\LoopInterface',false)? '\Workerman\Events\React\StreamSelectLoop':'\Workerman\Events\Select';
        }
        return self::$eventLoopClass;
    }
